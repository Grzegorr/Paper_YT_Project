...
#image_path = "Data/Example/Marcinek.jpg"
#image_path = "Data/Example/banana_guy.jpg"
#image_path = "Data/Example/Ja.jpg"
#image_path = "Data/Example/OHMC_kitchen1.jpg"
#image_path = "Data/Example/OHMC_kitchen2.jpg"
#image_path = "Data/Example/OHMC_kitchen3.jpg"
image_path = "Data/Example/OHMC_kitchen4.jpg"
...
try:
    ...
    cv2.imwrite("OpenPoseOnly.jpg", datum.cvOutputData)
...
for i in indices:
    ...
    draw_bounding_box(openPosedImage, class_ids[i], confidences[i], round(x), round(y), round(x + w), round(y + h))
...
cv2.imwrite("YOLOonly.jpg", image)
# release resources
cv2.destroyAllWindows()


BothNetworksImage = openPosedImage
# display output image
cv2.imshow("YOLO and openpose", BothNetworksImage)
# wait until any key is pressed
cv2.waitKey()
# save output image to disk
cv2.imwrite("YOLOandOpenPose.jpg", BothNetworksImage)
# release resources
cv2.destroyAllWindows()